"""
Apollo Enrichment Pipeline with Progress Tracking.
        ...
        if prospect.website:
            try:
                ...
                tracker.update_stage(lead_id, ProgressStage.ENRICHED_ADVANCED, {
                    ...
                    "wappalyzer_success": True
                })
            except Exception as e:
                tracker.add_error(lead_id, ProgressStage.ENRICHED_ADVANCED, f"Wappalyzer error: {str(e)}")
                
                # Add some mock technologies if none exist
...
async def main():
    ...
    print("Apollo Enrichment Pipeline with Progress Tracking")
    print("===============================================")
